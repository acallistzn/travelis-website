...
class Mahasiswa extends CI_Controller
{
    ...
    public function dashw()
    {
        ...
        $this->load->view('templates/menu');
        //load view index.php pada folder views/mahasiswa
        $this->load->view('mahasiswa/dashw', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function dashh()
    {
        ...
        $this->load->view('templates/menu');
        //load view index.php pada folder views/mahasiswa
        $this->load->view('mahasiswa/dashh', $data);
        $this->load->view('templates/footer');
    }

    public function dashr()
    {
        ...
        $this->load->view('templates/menu');
        //load view index.php pada folder views/mahasiswa
        $this->load->view('mahasiswa/dashr', $data);
        $this->load->view('templates/footer');
    }
