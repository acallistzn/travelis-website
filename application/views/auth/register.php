    ...
    <div class="container">
        ...
        <div class="card mt-6 o-hidden border-0 shadow-lg my-5 col-lg-5 mx-auto" >
                    ...
                    <div class="col-lg">
                        <div class="p-4">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4 mt-4"><b>REGISTRASI</b></h1>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit" style="background-color: #213555; width:100%;  margin: auto;" class="btn btn-primary btn-user btn-block">
                                    DAFTAR
                                </button>
                                <hr>
                            </form>
