    ...
    <section id="portfolio" class="portfolio">
        <div class="container">
          <div class="row d-flex justify-content=between">
            ...
            <h2 class=" mb-0 pb-0" style=" font-weight: 600;">di Lombok Bingung Mau ke Hotel Mana ???</h2>
                 
            <section id="katperkota" class="d-flex flex-column justify-content-center align-items-center mb-0 pb-0 m-0">
                <div class="container text-md-left" data-aos="fade-up">
          
                <a href="<?php echo base_url('travelis/bali_w'); ?>" class="btn-kat rounded-5">Wisata</a>
                <a href="<?php echo base_url('travelis/bali_h'); ?>" class="btn-kat btn-active rounded-5">Hotel</a>
              </div><br>
            </section>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item wow fadeInUp" data-wow-delay="0.1s">
              <div class="portfolio-wrap">
                <figure>
                  <img src="<?php echo base_url('assets/bali-hotel/the-one-legian.jpg'); ?>" class="img-fluid" alt="">
                ...
                <div class="portfolio-info" style="text-align: left">
                  <h4><a href="<?php echo base_url('travelis/detail'); ?>" style="text-decoration: none; font-size: 19px;">The One Legian</a></h4>
                  <i class="bi bi-star-fill" style="color: yellow; font-size: 19px;"></i>
                  <i class="bi bi-star-fill" style="color: yellow; font-size: 19px;"></i>
                  <i class="bi bi-star-fill" style="color: yellow; font-size: 19px;"></i>
                  <i class="bi bi-star-fill" style="color: yellow; font-size: 19px;"></i>
                  <p style="text-transform: none; font-size: 14px;">Rp 000,000</p>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item wow fadeInUp" data-wow-delay="0.1s">
              <div class="portfolio-wrap">
                <figure>
                  <img src="<?php echo base_url('assets/bali-hotel/the-trans-resort-bali.jpg'); ?>" class="img-fluid" alt="">
                  <a href="<?= base_url('mahasiswa'); ?>" class="link-preview" title="Pesan Tiket"><i class="bx bx-plus"></i></a>
                  <a href="<?= base_url('travelis/detail'); ?>" class="link-details" title="Lihat Deskripsi"><i class="bx bx-link"></i></a>
                </figure>
    
                <div class="portfolio-info" style="text-align: left">
                  <h4><a href="<?php echo base_url('travelis/detail'); ?>" style="text-decoration: none; font-size: 19px;">The Trans Resort Bali</a></h4>
                  <i class="bi bi-star-fill" style="color: yellow; font-size: 19px;"></i>
                  <i class="bi bi-star-fill" style="color: yellow; font-size: 19px;"></i>
                  <i class="bi bi-star-fill" style="color: yellow; font-size: 19px;"></i>
                  <i class="bi bi-star-fill" style="color: yellow; font-size: 19px;"></i>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item wow fadeInUp" data-wow-delay="0.1s">
              <div class="portfolio-wrap">
                <figure>
                  <img src="<?php echo base_url('assets/bali-hotel/kuta-central-park2.jpg'); ?>" class="img-fluid" alt="">
                  <a href="tiket_saya.html" class="link-preview portfolio-lightbox" title="Pesan Tiket"><i class="bx bx-plus"></i></a>
                    <a href="bali-KutaCentral.html" class="link-details" title="Lihat Deskripsi"><i class="bx bx-link"></i></a>
                </figure>
    
                <div class="portfolio-info" style="text-align: left">
                  <h4><a href="portfolio-details.html" style="text-decoration: none; font-size: 19px;">Kuta Central Park</a></h4>
                  <i class="bi bi-star-fill" style="color: yellow; font-size: 19px;"></i>
                  <i class="bi bi-star-fill" style="color: yellow; font-size: 19px;"></i>
                  <i class="bi bi-star-fill" style="color: yellow; font-size: 19px;"></i>
                  <i class="bi bi-star-fill" style="color: yellow; font-size: 19px;"></i>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item wow fadeInUp" data-wow-delay="0.1s">
              <div class="portfolio-wrap">
                <figure>
                  <img src="<?php echo base_url('assets/bali-hotel/the-banyumas2.jpg'); ?>" class="img-fluid" alt="">
                  <a href="<?= base_url('mahasiswa'); ?>" class="link-preview" title="Pesan Tiket"><i class="bx bx-plus"></i></a>
                  <a href="<?= base_url('travelis/detail'); ?>" class="link-details" title="Lihat Deskripsi"><i class="bx bx-link"></i></a>
                </figure>
    
                <div class="portfolio-info" style="text-align: left">
                  <h4><a href="<?php echo base_url('travelis/detail'); ?>" style="text-decoration: none; font-size: 19px;">The Banyumas Villa</a></h4>
                  <i class="bi bi-star-fill" style="color: yellow; font-size: 19px;"></i>
                  <i class="bi bi-star-fill" style="color: yellow; font-size: 19px;"></i>
                  <i class="bi bi-star-fill" style="color: yellow; font-size: 19px;"></i>
                  <p style="text-transform: none; font-size: 14px;">Rp 000,000</p>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item wow fadeInUp" data-wow-delay="0.1s">
              <div class="portfolio-wrap">
                <figure>
                  <img src="<?php echo base_url('assets/bali-hotel/b5 The Apurva Kempinski Bali2.jpg'); ?>" class="img-fluid" alt="">
                  <a href="<?= base_url('mahasiswa'); ?>" class="link-preview" title="Pesan Tiket"><i class="bx bx-plus"></i></a>
                  <a href="<?= base_url('travelis/detail'); ?>" class="link-details" title="Lihat Deskripsi"><i class="bx bx-link"></i></a>
                </figure>
    
                <div class="portfolio-info" style="text-align: left">
                  <h4><a href="<?php echo base_url('travelis/detail'); ?>" style="text-decoration: none; font-size: 19px;">The Apurva Kempinski</a></h4>
                  <i class="bi bi-star-fill" style="color: yellow; font-size: 19px;"></i>
                  <i class="bi bi-star-fill" style="color: yellow; font-size: 19px;"></i>
                  <i class="bi bi-star-fill" style="color: yellow; font-size: 19px;"></i>
                  <i class="bi bi-star-fill" style="color: yellow; font-size: 19px;"></i>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item wow fadeInUp" data-wow-delay="0.1s">
              <div class="portfolio-wrap">
                <figure>
                  <img src="<?php echo base_url('assets/bali-hotel/aston-kuta-hotel-residence.jpg'); ?>" class="img-fluid" alt="">
                  <a href="<?= base_url('mahasiswa'); ?>" class="link-preview" title="Pesan Tiket"><i class="bx bx-plus"></i></a>
                  <a href="<?= base_url('travelis/detail'); ?>" class="link-details" title="Lihat Deskripsi"><i class="bx bx-link"></i></a>
                </figure>
    
                <div class="portfolio-info" style="text-align: left">
                  <h4><a href="<?php echo base_url('travelis/detail'); ?>" style="text-decoration: none; font-size: 19px;">ASTON Kuta Hotel & Reside ...</a></h4>
                  <i class="bi bi-star-fill" style="color: yellow; font-size: 19px;"></i>
                  <i class="bi bi-star-fill" style="color: yellow; font-size: 19px;"></i>
                  <i class="bi bi-star-fill" style="color: yellow; font-size: 19px;"></i>
                  <i class="bi bi-star-fill" style="color: yellow; font-size: 19px;"></i>
